...
ax1.plot(xs, shift_angle(th1 + global_angle_shift), label=r'$\theta$')
ax1.plot(xs, shift_angle(Fs + global_angle_shift), label=r'$\beta + \delta$')
ax1.plot(xs, shift_angle(np.array(Fs) - np.array(th1) + global_angle_shift), label=r'$\beta + \delta - \theta$')
ax1.plot()
ax1.legend()
