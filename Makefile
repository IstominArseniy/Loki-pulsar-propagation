...
$(EXECUTABLE_TEST): $(LIBOBJECTS) $(OBJDIR)/main_test.o 
	$(CC) $(CFLAGS) $(LIBOBJECTS) $(OBJDIR)/main_test.o -o $@
...
$(OBJDIR)/main_test.o: $(SRCDIR)/main_test.cpp
	$(CC) $(CFLAGS) -c $< -o $@
